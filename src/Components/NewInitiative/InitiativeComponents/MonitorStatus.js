...
import trackStatus from '../../../assets/trackStatus.svg';
...
const MonitorStatus = () => {
  ...
  return (
    ...
    <div className='get-done'>
        <img src={trackStatus} alt="get it done" />
        <p className='text'>Track Status</p>
    </div>

    <Input placeholder='Your Initiative' value='Increase product sales this quarter by 30 percent' label='What is your Initiative?' />

    <SetupLabel>
        <label htmlFor="" className='label'>Name your initiative</label>
    </SetupLabel>
